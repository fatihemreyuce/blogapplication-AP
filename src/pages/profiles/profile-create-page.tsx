  ...
  return (
    <div className="animate-fade-in space-y-6 p-1">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-medium text-foreground">Yeni Profil</span>
      </div>

      <div>
        <h1 className="text-2xl font-bold text-foreground">Yeni Profil Oluştur</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Aşağıdaki formu doldurarak yeni bir kullanıcı profili ekleyin.
        </p>
      </div>
