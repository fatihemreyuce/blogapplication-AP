...
export function PostImageUploader({
  ...
  onChange,
  disabled,
  label = "Resmi sürükle bırak ya da seç",
  bucket = "post-covers",
  folder = "posts",
      ...
      if (uploadError) {
        throw new Error(
          uploadError.message.includes("Bucket not found")
            ? `Supabase Storage'da '${bucket}' bucket'ı bulunamadı. Supabase Dashboard > Storage bölümünden '${bucket}' adında public bir bucket oluştur.`
            : uploadError.message,
        );
      }
    ...
    <div className="space-y-2">
      ...
      >
        {isUploading ? (
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="rounded-full bg-muted/50 p-3 transition-colors group-hover:bg-brand-blue/10">
