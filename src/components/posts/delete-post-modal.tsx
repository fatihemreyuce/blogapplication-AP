...
import { AlertTriangle, FileText, ShieldAlert, Trash2, X } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-2xl border border-border/60 bg-card shadow-2xl">
        <div className="relative bg-red-500/8 px-6 pb-5 pt-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-muted-foreground">Post kaydını kalıcı olarak sileceksiniz.</p>
            </div>
          </div>
        </div>
        <form
        ...
        >
          ...
          <div className="rounded-xl border border-red-500/15 bg-red-500/5 p-4">
            ...
            <p className="text-sm text-foreground/80">Post içerikleri ve ilişkili bağlantılar etkilenebilir.</p>
          </div>
