...
import { AlertTriangle, BookOpen, ShieldAlert, Trash2, X } from "lucide-react";
        ...
        <div className="relative bg-red-500/8 px-6 pb-5 pt-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-muted-foreground">Seriyi kalıcı olarak sileceksiniz.</p>
            </div>
          </div>
        </div>
        <form
        ...
        >
          <div className="flex items-center gap-3 rounded-xl border border-border/50 bg-muted/30 p-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs font-mono text-muted-foreground">/{series.slug}</p>
            </div>
          </div>
          <div className="rounded-xl border border-red-500/15 bg-red-500/5 p-4">
            ...
            <p className="text-sm text-foreground/80">Seri kaydı kaldırılır ve içerik ilişkileri etkilenebilir.</p>
          </div>
